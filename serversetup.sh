...
if [ $server_type == "1" ]; then
	...
	yum install -y httpd php php-mbstring postfix mysql mysql-server php-mysql php-gd mod_ssl vsftpd pam_mysql nano wget mlocate mod_evasive mailx
...
EOF
	...
	echo "Installing dependencies.."
	yum install -y postfix dovecot nano dovecot-mysql zip unzip php php-mbstring httpd mailx mlocate rsync mysql-server php-xml gcc gdbm-devel postgrey vacation
