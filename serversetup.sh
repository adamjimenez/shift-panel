...
EOF
	...
	echo "Installing dependencies.."
	yum install -y postfix dovecot nano dovecot-mysql zip unzip tar php php-mbstring httpd mailx mlocate rsync mysql-server php-xml gcc gdbm-devel postgrey vacation
